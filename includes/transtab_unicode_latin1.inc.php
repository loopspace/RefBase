<?php
	...
	//
	// File:       ./includes/transtab_unicode_latin1.inc.php
	// Repository: $HeadURL$
	// Author(s):  Matthias Steffens <mailto:refbase@extracts.de>
	//
	// Created:    12-Jun-08, 12:15
	// Modified:   $Date: 2008-08-28 17:36:28 -0700 (Thu, 28 Aug 2008) $
	//             $Author$
	//             $Revision: 1214 $

	// This is a transliteration table for a best-effort conversion from Unicode to ISO-8859-1. It contains a comprehensive list of substitution strings for Unicode characters,
	...
	// NOTE: This is basically a copy of 'transtab_unicode_ascii.inc.php', but with the characters of the latin1 character set commented out.

	$transtab_unicode_latin1 = array(
